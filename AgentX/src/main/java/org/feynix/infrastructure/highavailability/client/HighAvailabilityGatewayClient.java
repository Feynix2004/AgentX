package org.feynix.infrastructure.highavailability.client;
...
import org.feynix.infrastructure.config.HighAvailabilityProperties;
import org.feynix.infrastructure.exception.BusinessException;
import org.feynix.infrastructure.highavailability.dto.request.ApiInstanceBatchCreateRequest;
import org.feynix.infrastructure.highavailability.dto.request.ApiInstanceBatchDeleteRequest;
import org.feynix.infrastructure.highavailability.dto.request.ApiInstanceCreateRequest;
import org.feynix.infrastructure.highavailability.dto.request.ApiInstanceUpdateRequest;
import org.feynix.infrastructure.highavailability.dto.request.ProjectCreateRequest;
import org.feynix.infrastructure.highavailability.dto.request.ReportResultRequest;
import org.feynix.infrastructure.highavailability.dto.request.SelectInstanceRequest;
import org.feynix.infrastructure.highavailability.dto.response.ApiInstanceDTO;
import org.feynix.infrastructure.highavailability.dto.response.GatewayResult;
...
public class HighAvailabilityGatewayClient {
    ...
    public void createApiInstance(ApiInstanceCreateRequest request) {
        ...
        try {
            ...
            try (CloseableHttpResponse response = httpClient.execute(httpPost)) {
                if (response.getStatusLine().getStatusCode() != 200) {
                    String responseBody = EntityUtils.toString(response.getEntity(), StandardCharsets.UTF_8);
                    logger.error("创建API实例失败，响应码: {}, 响应体: {}", 
                        response.getStatusLine().getStatusCode(), responseBody);
    ...
    public void updateApiInstance(String apiType, String businessId, ApiInstanceUpdateRequest request) {
        ...
        try {
            String url = String.format("%s/instances/%s/%s", 
            ...
            try (CloseableHttpResponse response = httpClient.execute(httpPut)) {
                if (response.getStatusLine().getStatusCode() != 200) {
                    String responseBody = EntityUtils.toString(response.getEntity(), StandardCharsets.UTF_8);
                    logger.error("更新API实例失败，响应码: {}, 响应体: {}", 
                        response.getStatusLine().getStatusCode(), responseBody);
                }
            }
    ...
    public void deleteApiInstance(String apiType, String businessId) {
        ...
        try {
            ...
            try (CloseableHttpResponse response = httpClient.execute(httpDelete)) {
                if (response.getStatusLine().getStatusCode() != 200) {
                    String responseBody = EntityUtils.toString(response.getEntity(), StandardCharsets.UTF_8);
                    logger.error("删除API实例失败，响应码: {}, 响应体: {}", 
                        response.getStatusLine().getStatusCode(), responseBody);
                }
            }
    ...
    public void activateApiInstance(String apiType, String businessId) {
        ...
        try {
            String url = String.format("%s/instances/%s/%s/activate",
                properties.getGatewayUrl(), apiType, businessId);
            ...
            try (CloseableHttpResponse response = httpClient.execute(httpPost)) {
                if (response.getStatusLine().getStatusCode() != 200) {
                    String responseBody = EntityUtils.toString(response.getEntity(), StandardCharsets.UTF_8);
                    logger.error("启用API实例失败，响应码: {}, 响应体: {}", 
                        response.getStatusLine().getStatusCode(), responseBody);
                } else {
    ...
    public void deactivateApiInstance(String apiType, String businessId) {
        ...
        try {
            ...
            try (CloseableHttpResponse response = httpClient.execute(httpPost)) {
                if (response.getStatusLine().getStatusCode() != 200) {
                    String responseBody = EntityUtils.toString(response.getEntity(), StandardCharsets.UTF_8);
                    logger.error("禁用API实例失败，响应码: {}, 响应体: {}", 
                        response.getStatusLine().getStatusCode(), responseBody);
                } else {
    ...
    public void batchCreateApiInstances(List<ApiInstanceCreateRequest> instances) {
        ...
        try {
            ...
            try (CloseableHttpResponse response = httpClient.execute(httpPost)) {
                if (response.getStatusLine().getStatusCode() != 200) {
                    String responseBody = EntityUtils.toString(response.getEntity(), StandardCharsets.UTF_8);
                    logger.error("批量创建API实例失败，响应码: {}, 响应体: {}", 
                        response.getStatusLine().getStatusCode(), responseBody);
