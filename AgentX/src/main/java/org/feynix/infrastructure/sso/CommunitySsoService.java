package org.feynix.infrastructure.sso;
...
import org.feynix.domain.sso.model.SsoUserInfo;
import org.feynix.domain.sso.service.SsoService;
...
public class CommunitySsoService implements SsoService {
    ...
    public String getLoginUrl(String redirectUrl) {
        ...
        return String.format("%s/sso/login?app_key=%s&redirect_url=%s", 
                baseUrl, appKey, redirectUrl != null ? redirectUrl : callbackUrl);
    }
    ...
    public SsoUserInfo getUserInfo(String authCode) {
        ...
        try {
            ...
            if (response == null || !Integer.valueOf(200).equals(response.get("code"))) {
                throw new BusinessException("获取Community用户信息失败: " + 
                    (response != null ? response.get("msg") : "未知错误"));
            }
