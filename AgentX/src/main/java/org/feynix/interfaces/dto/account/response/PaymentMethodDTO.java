package org.feynix.interfaces.dto.account.response;
...
public class PaymentMethodDTO {
    ...
    public PaymentMethodDTO(String platformCode, String platformName, boolean available, List<PaymentTypeDTO> paymentTypes) {
