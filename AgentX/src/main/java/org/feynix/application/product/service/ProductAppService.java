package org.feynix.application.product.service;
...
import org.feynix.application.product.assembler.ProductAssembler;
import org.feynix.application.product.dto.ProductDTO;
...
import org.feynix.interfaces.dto.product.request.CreateProductRequest;
import org.feynix.interfaces.dto.product.request.QueryProductRequest;
import org.feynix.interfaces.dto.product.request.UpdateProductRequest;
...
public class ProductAppService {
    ...
    public ProductDTO updateProduct(UpdateProductRequest request) {
        ...
        // 获取现有商品
        ProductEntity existingEntity = productDomainService.getProductById(request.getId());
        if (existingEntity == null) {
            throw new BusinessException("商品不存在");
        }
        
        // 更新字段
        ProductAssembler.updateEntity(existingEntity, request);
        
        // 保存更新
        ProductEntity updatedEntity = productDomainService.updateProduct(existingEntity);
