...
import org.feynix.domain.trace.constant.ExecutionPhase;
...
public abstract class TracingMessageHandler extends AbstractMessageHandler {
    ...
    protected <T> void processSyncChat(ChatContext chatContext, T connection, MessageTransport<T> transport,
        ...
        try {
            ...
            // 8. 发送完整响应
            var response = new org.feynix.application.conversation.dto.AgentChatResponse(responseText, true);
            ...
            // 错误处理
            var errorResponse = org.feynix.application.conversation.dto.AgentChatResponse.buildEndMessage(e.getMessage(), MessageType.TEXT);
    ...
    protected <T> void processChat(Agent agent, T connection, MessageTransport<T> transport, 
        ...
        tokenStream.onError(throwable -> {
            ...
            transport.sendMessage(connection,
                    org.feynix.application.conversation.dto.AgentChatResponse.buildEndMessage(throwable.getMessage(), MessageType.TEXT));
        ...
        tokenStream.onPartialResponse(reply -> {
            ...
            transport.sendMessage(connection, org.feynix.application.conversation.dto.AgentChatResponse.build(reply, MessageType.TEXT));
        });
        ...
        tokenStream.onCompleteResponse(chatResponse -> {
            ...
            // 发送结束消息
            transport.sendEndMessage(connection, org.feynix.application.conversation.dto.AgentChatResponse.buildEndMessage(MessageType.TEXT));
        ...
        tokenStream.onToolExecuted(toolExecution -> {
            ...
            if (!messageBuilder.get().isEmpty()) {
                transport.sendMessage(connection, org.feynix.application.conversation.dto.AgentChatResponse.buildEndMessage(MessageType.TEXT));
            ...
            transport.sendMessage(connection, org.feynix.application.conversation.dto.AgentChatResponse.buildEndMessage(message, MessageType.TOOL_CALL));
        });
