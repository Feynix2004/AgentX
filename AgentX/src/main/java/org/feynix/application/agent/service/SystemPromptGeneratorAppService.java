...
public class SystemPromptGeneratorAppService {
    ...
    public SystemPromptGeneratorAppService(
            SystemPromptGeneratorDomainService systemPromptGeneratorDomainService,
    ...
    public String generateSystemPrompt(SystemPromptGenerateRequest request, String userId) {
        ...
        return systemPromptGeneratorDomainService.generateSystemPrompt(
