package org.feynix.application.scheduledtask.service;

import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;
import org.feynix.application.scheduledtask.assembler.ScheduledTaskAssembler;
import org.feynix.application.scheduledtask.dto.ScheduledTaskDTO;
import org.feynix.domain.scheduledtask.model.ScheduledTaskEntity;
import org.feynix.domain.scheduledtask.service.ScheduledTaskDomainService;
import org.feynix.domain.scheduledtask.service.ScheduledTaskExecutionService;
import org.feynix.domain.scheduledtask.service.TaskScheduleService;
import org.feynix.interfaces.dto.scheduledtask.request.CreateScheduledTaskRequest;
import org.feynix.interfaces.dto.scheduledtask.request.UpdateScheduledTaskRequest;
...
public class ScheduledTaskAppService {
    ...
    public ScheduledTaskDTO updateScheduledTask(UpdateScheduledTaskRequest request, String userId) {
        ...
        if (updateEntity.getRepeatConfig() != null) {
            LocalDateTime nextExecuteTime = taskScheduleService.calculateNextExecuteTime(updateEntity, LocalDateTime.now());
