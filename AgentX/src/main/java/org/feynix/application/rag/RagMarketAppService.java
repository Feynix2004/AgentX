...
import org.feynix.application.rag.assembler.RagVersionAssembler;
import org.feynix.application.rag.assembler.UserRagAssembler;
import org.feynix.application.rag.dto.RagMarketDTO;
import org.feynix.application.rag.dto.UserRagDTO;
...
public class RagMarketAppService {
     ...
     * @return RAG市场列表
     */
    public Page<RagMarketDTO> getMarketRagVersions(Integer page, Integer pageSize, String keyword, String currentUserId) {
    ...
    public UserRagDTO installRagVersion(InstallRagRequest request, String userId) {
        ...
        // 转换为DTO并丰富信息
        UserRagDTO dto = UserRagAssembler.enrichWithVersionInfo(
                userRag,
                ragVersion.getOriginalRagId(),
                ragVersion.getFileCount(),
                ragVersion.getDocumentCount(),
                getUserNickname(ragVersion.getUserId())
        );
