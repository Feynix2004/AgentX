package org.feynix.application.container.service;

import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;
import org.feynix.application.container.assembler.ContainerAssembler;
import org.feynix.application.container.dto.ContainerDTO;
import org.feynix.interfaces.dto.container.request.CreateContainerRequest;
import org.feynix.domain.container.constant.ContainerStatus;
import org.feynix.domain.container.constant.ContainerType;
import org.feynix.domain.container.model.ContainerEntity;
import org.feynix.domain.container.model.ContainerTemplate;
import org.feynix.domain.container.model.ContainerTemplateEntity;
import org.feynix.domain.container.service.ContainerDomainService;
import org.feynix.domain.container.service.ContainerTemplateDomainService;
import org.feynix.infrastructure.docker.DockerService;
...
public class ContainerAppService {
    ...
    private static final String USER_VOLUME_BASE_PATH = "/docker/users";
    ...
    private String createUserVolumeDirectory(String userId) {
        ...
        if (!directory.exists()) {
            ...
            if (!created) {
                throw new BusinessException("创建用户数据目录失败: " + volumePath);
            }
        }
