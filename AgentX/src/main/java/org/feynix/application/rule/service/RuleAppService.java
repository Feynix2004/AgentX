package org.feynix.application.rule.service;
...
import org.feynix.interfaces.dto.PageResult;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;
import org.feynix.application.rule.assembler.RuleAssembler;
import org.feynix.application.rule.dto.RuleDTO;
import org.feynix.domain.rule.model.RuleEntity;
import org.feynix.domain.rule.service.RuleDomainService;
import org.feynix.infrastructure.exception.BusinessException;
import org.feynix.interfaces.dto.rule.request.CreateRuleRequest;
import org.feynix.interfaces.dto.rule.request.QueryRuleRequest;
import org.feynix.interfaces.dto.rule.request.UpdateRuleRequest;
...
public class RuleAppService {
    ...
    public RuleDTO updateRule(UpdateRuleRequest request) {
        // 获取现有规则
        RuleEntity existingEntity = ruleDomainService.getRuleById(request.getId());
        if (existingEntity == null) {
            throw new BusinessException("规则不存在");
        }
        
        // 更新字段
        RuleAssembler.updateEntity(existingEntity, request);
        
        // 保存更新
        RuleEntity updatedEntity = ruleDomainService.updateRule(existingEntity);
    ...
    public PageResult<RuleDTO> getRules(QueryRuleRequest request) {
        ...
        LambdaQueryWrapper<RuleEntity> wrapper = Wrappers.<RuleEntity>lambdaQuery()
                ...
                .and(StringUtils.isNotBlank(request.getKeyword()), w -> {
                    ...
                    w.like(RuleEntity::getName, keyword)
                     .or().like(RuleEntity::getDescription, keyword);
                })
        ...
        PageResult<RuleDTO> resultPage = new PageResult<>(
                page.getCurrent(),
                page.getSize(),
                page.getTotal()
        );
