...
import org.feynix.domain.rag.dto.req.RerankRequest;
import org.feynix.domain.rag.dto.resp.RerankResponse;
...
public class RerankDomainService {
    ...
    public List<EmbeddingMatch<TextSegment>> rerankDocument(
        ...
        // todo feynix 我觉得把这一块抽离出来做成 ReRankAPI放在 基础设施层，让 api 和业务剥离开来，这样
        // /Users/feynix/course/AgentX/AgentX/src/main/java/org/feynix/domain/rag/dto/req/resp 就可以抽离了
