...
public enum FileProcessStatusEnum {
    ...
    /** 初始化状态 */
    INIT_WAIT(0, "待初始化"), INIT_PROCESSING(1, "初始化中"), INIT_COMPLETED(2, "初始化完成"), INIT_FAILED(3, "初始化失败"),

    /** 向量化状态 */
    EMBEDDING_WAIT(0, "待向量化"), EMBEDDING_PROCESSING(1, "向量化中"), EMBEDDING_COMPLETED(2, "向量化完成"), EMBEDDING_FAILED(3,
            "向量化失败");
