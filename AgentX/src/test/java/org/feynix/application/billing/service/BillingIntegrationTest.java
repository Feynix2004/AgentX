package org.feynix.application.billing.service;
...
import org.feynix.domain.rule.constant.RuleHandlerKey;
...
import org.feynix.infrastructure.billing.strategy.BillingStrategy;
import org.feynix.infrastructure.billing.strategy.BillingStrategyFactory;
...
public class BillingIntegrationTest {
    ...
    public void testInsufficientBalance() {
        ...
        BillingContext context = BillingContext.builder()
            ...
            .serviceId("expensive_service")
            .usageData(Map.of("quantity", 1))
            .requestId("insufficient-balance-test-" + System.currentTimeMillis())
            .userId(testUserId)
            .build();
