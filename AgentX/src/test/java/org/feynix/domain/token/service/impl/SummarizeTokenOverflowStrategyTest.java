package org.feynix.domain.token.service.impl;
...
public class SummarizeTokenOverflowStrategyTest {
    ...
    public void testProcess() {
        ...
        // 验证摘要消息
        boolean hasSummaryMessage = result.stream()
                .anyMatch(m -> "summary".equals(m.getRole()));
        ...
        List<TokenMessage> latestMessages = sortedOriginal.subList(
                sortedOriginal.size() - config.getSummaryThreshold(), 
                sortedOriginal.size());
