...
import org.feynix.infrastructure.config.S3Properties;
import org.feynix.infrastructure.storage.OssUploadService;
import org.feynix.infrastructure.storage.OssUploadService.UploadCredential;
...
public class OssUploadTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("  Policy: " + credential.getPolicy().substring(0, Math.min(50, credential.getPolicy().length())) + "...");
            System.out.println("  签名: " + credential.getSignature().substring(0, Math.min(20, credential.getSignature().length())) + "...");
