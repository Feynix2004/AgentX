...
class MarkdownSplitterTest {
    ...
    void shouldProcessRealDocument() throws Exception {
        // Given - 读取真实文档
        String docPath = "src/test/java/org/feynix/infrastructure/rag/doc/AgentX 讲义.md";
        ...
        long sectionCount = segments.stream()
                .filter(s -> org.feynix.domain.rag.model.enums.SegmentType.SECTION.equals(s.getType())).count();
