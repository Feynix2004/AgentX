...
- **Required Imports**: 
  ...
  import org.feynix.interfaces.dto.PageResult; // 分页结果
  ```
...
### 分页相关规范
- **分页基类**: 所有查询请求类必须继承`org.feynix.interfaces.dto.Page`，不使用第三方包
  ```java
  // 正确
...
**获取TypeHandler参考**：
参考现有实现：`@AgentX/src/main/java/org/feynix/infrastructure/converter/ToolTypeConverter.java`
